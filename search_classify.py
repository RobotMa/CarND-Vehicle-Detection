    ...
    for xb in range(nxsteps):
        for yb in range(nysteps):
            ...
            if test_prediction == 1:
                ...
                cv2.rectangle(draw_img,(xbox_left, ytop_draw+y_start_stop[0]),(xbox_left+win_draw,ytop_draw+win_draw+y_start_stop[1]),(0,0,255),6)
...
plt.imshow(out_img)
plt.savefig('bbox-example-image-detected.jpg')
